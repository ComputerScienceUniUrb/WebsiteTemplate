				    ...
				    <div id="main" class="eightcol first clearfix" role="main">
					    ...
					    <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						    ...
						    <header class="article-header">
							    ...
							    <p class="meta"><?php _e('Posted', 'stitheme'); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time(get_option('date_format')); ?></time> <?php _e('by', 'stitheme'); ?> <?php the_author_posts_link(); ?> <span class="amp">&</span> <?php _e('filed under', 'stitheme'); ?> <?php the_category(', '); ?>.</p>
					    ...
					    <?php else : ?>
					        ...
					        <article id="post-not-found" class="hentry clearfix">
					        	...
					        	<footer class="article-footer">
					        	    <p><?php _e("This is the error message in the index.php template.", "stitheme"); ?></p>
					        	</footer>
					        </article>
